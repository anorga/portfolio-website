  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute -left-56 top-[8%] h-[34rem] w-[34rem] rounded-full [background-image:radial-gradient(circle,color-mix(in_oklab,var(--accent)_12%,transparent),transparent_68%)]"
      />
      <motion.div
        style={shouldReduceMotion ? undefined : { x: secondX, y: secondY }}
        className="absolute -right-64 top-[42%] h-[38rem] w-[38rem] rounded-full [background-image:radial-gradient(circle,color-mix(in_oklab,var(--accent)_10%,transparent),transparent_68%)]"
      />
