        ...
        <Fragment>
            <div className="bg-gray-50">
                <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
                    <div className="flex gap-40 px-6">
                        <img src={portrait} alt="portrait" className="w-96 h-full rounded-xl opacity-95 hidden lg:block" />
                        <div className="my-auto">
                            <p><span className="text-[100px]">Hello!</span><br></br>
                    ...
                    <div className="relative mt-20">
                        ...
                        <div className="relative flex justify-center">
                            <span className="px-3 font-semibold text-black uppercase bg-gray-50 sm:text-lg md:text-2xl">About Me</span>
                        </div>
                    </div>
                    <div className="px-5 mt-5 bg-gray-50 flex flex-col lg:flex-row">
                        <p className="mx-auto mt-6 px-3 md:px-4 leading-7 text-black max-w-7xl sm:text-lg md:text-xl md:leading-9">
                            Hello there! I am a front-end developer with a passion for building web applications and a deep interest in everything related to web development. The endless combination of technology and creativity in this field drives my passion and excitement to keep learning and building. Please refer to the <Link to={'/Projects'} className="hover:text-red-700 animate-pulse">Projects</Link> section for recent applications I have worked on.
                        </p>
                        <p className="mx-auto mt-6 px-3 md:pl-7 leading-7 text-black max-w-7xl sm:text-lg md:text-xl md:leading-9">
