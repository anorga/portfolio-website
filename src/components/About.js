                ...
                <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center">
                            <span className="px-3 font-semibold text-gray-600 uppercase bg-white sm:text-lg md:text-xl">About Me</span>
                        </div>
                    </div>
                    <div className="px-5 pt-1 pb-8 bg-gray-50 mt-7">
                        <p className="max-w-5xl mx-auto mt-6 leading-7 text-gray-500 sm:text-lg md:text-xl md:leading-8">
