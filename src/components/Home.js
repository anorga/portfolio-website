        ...
        <div className="relative pt-6 pb-16 sm:pb-24">
          ...
          <main className="px-4 mx-auto mt-16 max-w-7xl sm:mt-24">
            <div className="text-center">
              ...
              <p className="max-w-md mx-auto mt-8 text-base font-bold text-gray-500 sm:text-lg md:mt-5 md:text-lg md:max-w-3xl">
                Welcome to my portfolio website
              </p>
              <div className="max-w-md mx-auto mt-20 sm:flex sm:justify-center md:mt-8">
